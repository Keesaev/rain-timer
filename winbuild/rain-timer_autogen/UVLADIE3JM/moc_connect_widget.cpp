/****************************************************************************
** Meta object code from reading C++ file 'connect_widget.h'
**
...
#include <memory>
#include "../../../src/connect_widget.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'connect_widget.h' doesn't include <QObject>."
...
QT_INIT_METAOBJECT const QMetaObject ConnectWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ConnectWidget.data,
    qt_meta_data_ConnectWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
