/****************************************************************************
** Meta object code from reading C++ file 'port_handler.h'
**
...
#error "The header file 'port_handler.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 25, 5), // "write"
QT_MOC_LITERAL(4, 31, 11), // "QByteArray&"
QT_MOC_LITERAL(5, 43, 4), // "data"
QT_MOC_LITERAL(6, 48, 7), // "onError"
QT_MOC_LITERAL(7, 56, 28), // "QSerialPort::SerialPortError"
QT_MOC_LITERAL(8, 85, 3) // "err"

    },
    "PortHandler\0onReadyRead\0\0write\0"
    "QByteArray&\0data\0onError\0"
...
void PortHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->write((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
